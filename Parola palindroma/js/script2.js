...
// function reverseWord (wordToBeReversed) {
  ...
  // soluzione 1
    ...
    // }
                        // stringa    // array    // array     // funzione din un array che unisce
                                      // diviso // invertito  // stringa
//     const reversedWord = wordToBeReversed.split('').reverse().join('');
//     // chaining ovvero mettere più funzioni una dietro l'altra con i punti 
